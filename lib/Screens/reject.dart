...
import 'package:stubus_admin/Screens/form.dart';
import 'package:stubus_admin/Screens/showform.dart';

Future<List> getData() async {
  var url = "https://buspassnivi.000webhostapp.com/rejectedform.php";
...
class rejectform extends StatefulWidget {
  @override
  _rejectformState createState() => _rejectformState();
}

class _rejectformState extends State<rejectform> {
  @override
  void initState() {
    super.initState();
  }
